...
import { Route as AppProjectionsRouteImport } from './routes/app.projections'
...
export interface FileRoutesByFullPath {
  ...
  '/app/projections': typeof AppProjectionsRoute
...
export interface FileRouteTypes {
  ...
  fullPaths: '/' | '/app' | '/app/projections' | '/app/stats' | '/app/'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/app/projections' | '/app/stats' | '/app'
  id: '__root__' | '/' | '/app' | '/app/projections' | '/app/stats' | '/app/'
